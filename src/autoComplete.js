 ...
 * @param {Object} [config.atr] - Set attributes on the input element. For example, "placeholder, etc..".
 ...
 * @param {Boolean} [config.wrapper=true] - Wraps the input element in a div for accessibility purposes, adding some ARIA attributes.
 ...
 * @param {String} [config.resultsList.atr] - Set attributes on the resultsList element. For example, "class, etc..".
 ...
 * @param {String} [config.resultItem.atr] - Set attributes on the resultItem element. For example, "class, etc..".
