...
| -------------- | ------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `data`         | Data Source, Data Key, Data Caching & Data Results                 | `Object` with 4 methods <br> **1- src**: <br> - `Array` of `Strings` / `Objects`<br>**OR**<br> - `Function` ( ) => `Array` of `Strings` / `Objects` <br> **2- key**: <br>- `Array` of `Strings`<br>**Required** if `src` is `Object`, for search to point to desired `keys` <br> **3- Cache**: <br> - `true` for static data `src` <br> - `false` for dynamic data `src` "API" with queries <br> **4- Results**: <br> - (list) => Array of Strings / Objects                                                                                                   | Data `src`                                                                                                                                                                                                                                                            |
| `trigger`      | Engine event & condition trigger                                   | `Object` with 2 methods <br> **1- event**: <br> - `Array` of `Strings` <br> **2- condition**: <br>- `Function` `(query)` => Condition `String`                                                                                                                                                                                                                                                                                                                                                                                                                 | 1- event: `["input"]` <br> 2- condition: <br> `(query.length > this.threshold && query !== " ")`                                                                                                                                                                      |
