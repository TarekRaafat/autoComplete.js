...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@8.2.2/dist/css/autoComplete.min.css">
```
...
-   <a href="https://unpkg.com/browse/@tarekraafat/autocomplete.js@8.2.2/"><img src="./img/logos/unpkg_logo.png" alt="unpkg Logo" width="100px"></a> CDN

`CSS`

```html
<link rel="stylesheet" href="https://unpkg.com/@tarekraafat/autocomplete.js@8.2.2/dist/css/autoComplete.css">
```

`JS`

```html
<script src="https://unpkg.com/@tarekraafat/autocomplete.js@8.2.2/dist/js/autoComplete.min.js"></script>
```
