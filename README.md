...
autoComplete.js is a pure vanilla Javascript library, that's built for speed, high versatility and seemless integration with wide variety of projects & systems.
