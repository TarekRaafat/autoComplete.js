...
```html
<script src="https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@10.0.0/dist/js/autoComplete.min.js"></script>
```

`CSS`

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@10.0.0/dist/css/autoComplete.min.css">
```
#### Package Manager
