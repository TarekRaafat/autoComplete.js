...
```html
<script src="https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@11.0.0/dist/autoComplete.min.js"></script>
```

`CSS`

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@11.0.0/dist/css/autoComplete.min.css">
```
#### Package Manager
