...
onSelection: feedback => {
  ...
  document.querySelector(".selection").innerHTML = `<img src="${image}" style="height: 40vh; border-radius: 8px; box-shadow: 0 0 80px rgba(255, 122, 122,0.2), 0 4px 10px -3px rgba(255, 122, 122,0.4), inset 0 -10px 30px -5px rgba(255, 122, 122,0.1);"></img>`;
  // Clear Input
